...
namespace DeclGUI.Editor.Renderers
{
    ...
    public class EditorVector2FieldRenderer : EditorElementRenderer<Vector2Field>
    {
        ...
        public override void Render(RenderManager mgr,in Vector2Field element)
        {
        ...
        /// </summary>
        public override Vector2 CalculateSize(RenderManager mgr,in Vector2Field element,in DeclStyle? style)
        {
            var editorMgr = mgr as EditorRenderManager;
            if (editorMgr == null)
                return Vector2.zero;
