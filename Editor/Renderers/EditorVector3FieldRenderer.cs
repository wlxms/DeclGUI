...
namespace DeclGUI.Editor.Renderers
{
    ...
    public class EditorVector3FieldRenderer : EditorElementRenderer<Vector3Field>
    {
        ...
        public override void Render(RenderManager mgr,in Vector3Field element, in IDeclStyle styleParam)
        {
        ...
        /// </summary>
        public override Vector2 CalculateSize(RenderManager mgr,in Vector3Field element,in IDeclStyle style)
        {
            var editorMgr = mgr as EditorRenderManager;
            if (editorMgr == null)
                return Vector2.zero;
