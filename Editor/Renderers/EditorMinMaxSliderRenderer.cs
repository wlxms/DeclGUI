...
namespace DeclGUI.Editor.Renderers
{
    ...
    public class EditorMinMaxSliderRenderer : EditorElementRenderer<MinMaxSlider>
    {
        ...
        public override void Render(RenderManager mgr,in MinMaxSlider element)
        {
        ...
        /// </summary>
        public override Vector2 CalculateSize(RenderManager mgr,in MinMaxSlider element,in DeclStyle? style)
        {
            var editorMgr = mgr as EditorRenderManager;
            if (editorMgr == null)
                return Vector2.zero;
