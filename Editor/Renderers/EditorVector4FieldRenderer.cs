...
namespace DeclGUI.Editor.Renderers
{
    ...
    public class EditorVector4FieldRenderer : EditorElementRenderer<Vector4Field>
    {
        ...
        public override void Render(RenderManager mgr,in Vector4Field element)
        {
        ...
        /// </summary>
        public override Vector2 CalculateSize(RenderManager mgr,in Vector4Field element,in DeclStyle? style)
        {
            var editorMgr = mgr as EditorRenderManager;
            if (editorMgr == null)
                return Vector2.zero;
