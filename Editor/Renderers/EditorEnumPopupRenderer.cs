...
namespace DeclGUI.Editor.Renderers
{
    ...
    public class EditorEnumPopupRenderer : EditorElementRenderer<EnumPopup>
    {
        ...
        public override void Render(RenderManager mgr, in EnumPopup element)
        {
        ...
        /// 计算EnumPopup元素的期望大小
        /// </summary>
        public override Vector2 CalculateSize(RenderManager mgr, in EnumPopup element, in DeclStyle? style)
        {
            var editorMgr = mgr as EditorRenderManager;
            if (editorMgr == null)
                return Vector2.zero;
