...
namespace DeclGUI.Editor.Renderers
{
    ...
    public class EditorLayerFieldRenderer : EditorElementRenderer<LayerField>
    {
        ...
        public override void Render(RenderManager mgr, in LayerField element)
        {
        ...
        /// 计算LayerField元素的期望大小
        /// </summary>
        public override Vector2 CalculateSize(RenderManager mgr, in LayerField element, in DeclStyle? style)
        {
            var editorMgr = mgr as EditorRenderManager;
            if (editorMgr == null)
                return Vector2.zero;
