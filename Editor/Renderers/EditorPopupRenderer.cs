...
namespace DeclGUI.Editor.Renderers
{
    ...
    public class EditorPopupRenderer : EditorElementRenderer<Popup>
    {
        ...
        public override void Render(RenderManager mgr,in Popup element, in IDeclStyle styleParam)
        {
        ...
        /// 计算Popup元素的期望大小
        /// </summary>
        public override Vector2 CalculateSize(RenderManager mgr,in Popup element,in IDeclStyle style)
        {
            var editorMgr = mgr as EditorRenderManager;
            if (editorMgr == null)
                return Vector2.zero;
