...
namespace DeclGUI.Editor.Renderers
{
    ...
    public class EditorToggleRenderer : EditorElementRenderer<Toggle>
    {
        ...
        public override void Render(RenderManager mgr,in Toggle element)
        {
            ...
            try
            {
                var style = editorMgr.ApplyStyle(element.Style, EditorStyles.toggle);
        ...
        /// 计算Toggle元素的期望大小
        /// </summary>
        public override Vector2 CalculateSize(RenderManager mgr,in Toggle element,in DeclStyle? style)
        {
            var editorMgr = mgr as EditorRenderManager;
            if (editorMgr == null)
                return Vector2.zero;
