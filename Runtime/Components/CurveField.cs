...
namespace DeclGUI.Components
{
    ...
    /// 用于编辑AnimationCurve
    /// </summary>
    public struct CurveField : IElement
    {
        /// <summary>
        /// 事件注册器
        /// </summary>
        ...
        /// 当前曲线值
        /// </summary>
        public AnimationCurve Value { get; }
        
        /// <summary>
        /// 值变化回调
        /// </summary>
        public System.Action<AnimationCurve> OnValueChanged { get; }
        ...
        /// 创建曲线编辑器组件
        /// </summary>
        /// <param name="value">当前曲线值</param>
        /// <param name="onValueChanged">值变化回调</param>
        /// <param name="style">样式</param>
        public CurveField(AnimationCurve value, System.Action<AnimationCurve> onValueChanged = null, DeclStyle style = default)
        {
            Value = value;
  ...
  public IElement Render() => null;
        ...
        /// <returns>带样式的曲线编辑器组件</returns>
        public CurveField WithStyle(DeclStyle style)
        {
            return new CurveField(Value, OnValueChanged, style);
        }
    }
}