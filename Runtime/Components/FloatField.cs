...
namespace DeclGUI.Components
{
    ...
    /// 用于显示和编辑浮点数值
    /// </summary>
    public struct FloatField : IElement
    {
        /// <summary>
        /// 事件注册器
        /// </summary>
        ...
        public FloatField(float value, System.Action<float> onValueChanged = null, DeclStyle style = default)
        {
            Value = value;
  ...
  public IElement Render() => null;
        ...
        /// <returns>带样式的浮点数字段组件</returns>
        public FloatField WithStyle(DeclStyle style)
        {
            return new FloatField(Value, OnValueChanged, style);
        }
    }
}